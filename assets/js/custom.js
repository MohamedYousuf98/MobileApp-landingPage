(function ($) {
  ...
  // Navbar Menu JS
  $(
    ".navbar .navbar-nav li a, .main-banner-content .btn, .cta-area .btn, .who-we-are .btn, .tabs_item_content .btn, .call-to-action-content .btn"
  ).on("click", function (e) {
    var anchor = $(this);
    $("html, body")
      .stop()
  ...
  // Count Time
  function makeTimer() {
    var endTime = new Date("September 20, 2050 17:00:00 PDT");
